...
<head>
	...
	<title>CareerCue - Contact Us</title>
    ...
    <meta property="og:image:alt" content="CareerCue" />
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								...
								<li>
										<h5>Email</h5><a href="mailto:careercue@example.com">careercue@example.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+91 00000 00000">+91 00000 00000</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About CareerCue</h5>
											<p>CareerCue is a job portal and online job management system developed by Sachin Venkat, Ahinaya, and Akhila as part of their project in March 2025.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">CareerCue Contact</h5>
								
								<p>Address: Bangalore</p>
								<p>Email : <a href="mailto:careercue@example.com">careercue@example.com</a></p>
								<p>Phone : <a href="tel:+233546607474">+91 00000 00000</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> CareerCue</p>
